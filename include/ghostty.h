...
typedef enum {
  ...
  GHOSTTY_ACTION_COMMAND_HISTORY_CHANGED,
...
GHOSTTY_API void ghostty_surface_set_size_live(ghostty_surface_t, uint32_t, uint32_t);
GHOSTTY_API void ghostty_surface_commit_size(ghostty_surface_t);
