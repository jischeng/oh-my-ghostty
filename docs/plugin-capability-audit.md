...
| Inspector pane | Partial | Core host, tab-scoped typed tree snapshots/actions, persistence, shortcut, recursive `builtin.files`, and pane lifecycle are connected; v1 wire registration/update/action messages are not implemented. |
